...
final itensProximosProvider = FutureProvider<List<Item>>((ref) async {
  final itensRepository = ref.watch(itemRepositoryProvider); // Corrigido para itemRepositoryProvider
  ...
  try {
    ...
    return itensModel.cast<Item>(); // ItemModel estende Item, então o cast é seguro.
  } catch (e) {
